...
Tenho trabalhado e estudado conceitos envolvendo:

`AWS` · `EC2` · `S3` · `CloudFront` · `Route 53` · `Lambda` · `Aurora PostgreSQL` · `API Gateway` · `IAM` · `Secrets Manager` · `AWS Bedrock` · `Terraform` · `Docker` · `CI/CD`
...
Atuação como desenvolvedor Full Stack, trabalhando principalmente com:

`Java` · `Spring` · `Angular` · `TypeScript` · `PostgreSQL` · `APIs` · `AWS`
